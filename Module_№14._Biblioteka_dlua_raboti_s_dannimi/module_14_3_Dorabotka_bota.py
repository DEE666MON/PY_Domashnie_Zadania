...
kb.add(buttonKB1, buttonKB2, buttonKB3)
...
async def get_buying_list(message):
    print(message.text)
    for i in range(1, 5):
        print(f"Название: Таблеточки{i} | Описание: описание таблеточки{i} | Цена: {i * 100}")
        await message.answer(f"Название: Таблеточка{i} | Описание: описание таблеточки{i} | Цена: {i * 100}")
